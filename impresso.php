...
function gerarPDF() {
  ...
  html2canvas(document.getElementById("pagina1")).then(function (canvas) {
    ...
    doc.addImage(img2, 'JPEG', 20, 20, 550, 820, '', 'FAST');
    retorno2 = doc.output('datauristring');
    arquivoPDF = JSON.stringify(retorno2);
    getJson.arquivoTermo = arquivoPDF;
    doc.save();
    
    
    var delayInMilliseconds = 2000; //2 secon
    setTimeout(function() {enviarAPI(arquivoPDF);}, delayInMilliseconds);
 })
};
...
function base64ToJson(base64String) {
  ...
  .then(data => {
    ...
    window.confirm("O Formulário foi enviado para a análise.");
  })
  .catch(error => {
...
[<?php  if($_POST['opca'] == "opc1_2") {  if($_POST['opcz2'] == "opc1_2_2") { echo " X "; } } ?>] Contribuição de Serviço Passado 
Percentual 
<?php  if($_POST['opca'] == "opc1_2") {  if($_POST['opcz2'] == "opc1_2_2") { echo $_POST['porcentual2']; } } ?> 
%, por cento<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

[<?php  if($_POST['opca'] == "opc1_2") {  if($_POST['opcz3'] == "opc1_2_3") { echo " X "; } } ?>] Contribuição Voluntária Mensal
Percentual 
<?php   if($_POST['opca'] == "opc1_2") {  if($_POST['opcz3'] == "opc1_2_3") {echo $_POST['porcentual3'];  } } ?>
%, por cento<br />
<br />
